...
public class ComAckNaLeituraJobConfiguration {
	...
	@Autowired 
	public PubSubTemplateItemReader pubsubTemplateItemReader;		//<- faz ack na leitura..

	@Autowired
	CommonsPubSubStep commonsStep;
	
	@Bean
	public Job simplePubsubAckTestJob() {
		return jobBuilderFactory.get("simple-reader-ack-job")
